...
def main():
    ...
    target_cloud = pcl.load(
        '/home/acca/catkin_ws/src/ACCA2022-new/map_matching_localization/data/school.pcd')
    print('Loaded ' + str(target_cloud.size) +
          ' data points from /home/acca/catkin_ws/src/ACCA2022-new/map_matching_localization/data/school.pcd')
