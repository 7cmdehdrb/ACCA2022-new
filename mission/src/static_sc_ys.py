...
class Obstacle(object):
    ...
    def __init__(self, state):
        ...
        path_data = pd.read_csv("/home/acca/catkin_ws/src/ACCA2022-new/mission/data/sc/ys/static_path.csv")
        center_data = pd.read_csv("/home/acca/catkin_ws/src/ACCA2022-new/mission/data/sc/ys/static_center.csv")
        left_data = pd.read_csv("/home/acca/catkin_ws/src/ACCA2022-new/mission/data/sc/ys/static_left.csv")
        ...
        #obstacle mapping
        self.list1 = []
        self.list2 = deque(maxlen=700)
        self.list3 = deque(maxlen=700)
        self.list4 = []
